...
If you need local CUDA or GPU pass-through for model fine-tuning, use the dedicated template in [.devcontainer/gpu/devcontainer.json](gpu/devcontainer.json) and read the usage notes in [.devcontainer/gpu/README.md](gpu/README.md).
